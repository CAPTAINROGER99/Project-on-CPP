...
char getComputerOption() {
    srand(time(0));     //to generate random number with real time change           When you pass time(0) to srand(), you’re setting the seed of the random number generator to the current time
    // Random number
    int num = rand() % 3 + 1;       //here in num we are just getting any random number in the range of 1 to 3.
